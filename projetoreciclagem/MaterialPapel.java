...
public class MaterialPapel extends MaterialReciclavel implements Reciclagem {
	...
	public void calcularReciclaveis() 
	{
		...
		escolha = leia.nextLine();
		do {
			if (escolha.equalsIgnoreCase("Jornal") || escolha.equalsIgnoreCase("Revista") || escolha.equalsIgnoreCase("Livro") || escolha.equalsIgnoreCase("Papelão")) {
				validapapel = true;
			} else {
				validapapel = false;
		...
		if(escolha.equalsIgnoreCase("papelão")) 
		{
